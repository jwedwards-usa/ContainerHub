...
The catalog currently contains **294 verified product records across 42 shards**, plus **11 additional retailer/pack offers**. It preserves the coordinated Sterilite, IRIS, Akro-Mils, Rubbermaid, Cambro, Quantum, Uline, Really Useful Box and Buckhorn families, including 12 Akro-Grid dividable boxes, all 13 current Uline Clear Plastic Shelf Bin sizes and all seven current standard Cambro FreshPro CamRounds.
