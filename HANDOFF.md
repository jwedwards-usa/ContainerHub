...
The all-worker reconciliation preserves the manufacturer/industrial waves, retailer breadth waves, five recovered Really Useful Box sizes, the 13-SKU Uline Clear Plastic Shelf Bin recovery, the seven-size Cambro FreshPro CamRound family, and the complete 12-model Akro-Mils Akro-Grid dividable-container family.

Recent manufacturer and industrial coverage includes the six-size Akro-Mils Attached Lid Container family; all 12 current Akro-Grid models; Buckhorn straight-wall and eight attached-lid totes; all three Cambro Classic CamRound material families; Classic and FreshPro CamSquares; all seven current standard FreshPro CamRounds; Quantum QUS through QUS275MOB; eight Uline Clear Industrial attached-lid totes; 13 Uline Clear Plastic Shelf Bins; and Really Useful Box sizes through 64 L.

### Akro-Mils Akro-Grid
Akro-Grid coverage includes models 33105, 33162, 33164, 33165, 33166, 33168, 33220, 33222, 33223, 33224, 33226 and 33228. Current Akro-Mils specifications provide outside dimensions, bottom interior footprints, inside heights, gallon capacities and load ratings. Current exact-model purchase pages are retained where available. Optional dividers and clear snap-on lids are accessories, not separate physical containers.

### Worker reconciliation
Historical worker ancestry is represented in the coordinated Git history, and stale branch manifests are not allowed to replace newer trees. The old `catalog/integration-all-262-20260820` branch is a superseded precursor; `catalog/integration-all-262-rebased-20260820` is fully behind the coordinated branch with no files ahead. The Akro-Grid source branch is merged as ancestry while the integration tree is rebuilt from the newest `main`.
