import {capacityLabel, expandCatalogShard, lengthLabel, searchRecords, toMm, weightLabel} from './src/catalog.js';
...
async function loadCatalog() {
  ...
  const loaded=catalogs.flatMap(expandCatalogShard);
